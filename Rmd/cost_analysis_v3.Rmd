---
title: 'FLW scenarios: methods and preliminary results (V3.1)'
...
Separate values for each parameter are calculated for each of the many sectors within each FSC stage. Figure 8 shows a representative cost curve for one sector from each food supply chain stage.
