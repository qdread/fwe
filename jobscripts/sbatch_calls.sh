...
sbatch --export=vector_file=/nfs/fwe-data/landuse/ecoregions/tnc_usa.shp,raster_file=/nfs/fwe-data/landuse/NLCD/nlcd2016landcover.vrt,output_file=/nfs/fwe-data/landuse/NLCD/NLCD_2016_TNC.csv countpixels.sh
