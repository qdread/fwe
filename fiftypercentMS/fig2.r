# figure 2 in manuscript. Copied from impactcomparewithlit.r
...
pdf('~/google_drive/SESYNC Food Waste/Model_MS1/stoten_revision/figures_final/fig2.pdf', height = 4, width = 8)
