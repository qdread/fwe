...
fp <- ifelse(dir.exists('Q:/'), 'Q:/raw_data/ERS/LAFA', ifelse(dir.exists('/nfs/qread-data'), '/nfs/qread-data/raw_data/ERS/LAFA', '~/Dropbox/projects/foodwaste/Data/LAFA_localcopy'))
